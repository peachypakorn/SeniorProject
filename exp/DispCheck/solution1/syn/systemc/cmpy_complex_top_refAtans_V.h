...
#ifndef _cmpy_complex_top_refAtans_V_H_
#define _cmpy_complex_top_refAtans_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "cmpy_complex_top_refAtans_V_memcore.h"

SC_MODULE(cmpy_complex_top_refAtans_V) {
...
protected:
    ...
    cmpy_complex_top_refAtans_V_memcore* cmpy_complex_top_refAtans_V_memcore_U;
...
public:
    ...
    SC_CTOR(cmpy_complex_top_refAtans_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        cmpy_complex_top_refAtans_V_memcore_U = new cmpy_complex_top_refAtans_V_memcore("cmpy_complex_top_refAtans_V_memcore_U");
        cmpy_complex_top_refAtans_V_memcore_U->clk      ( clk );
        cmpy_complex_top_refAtans_V_memcore_U->reset    ( reset );
        cmpy_complex_top_refAtans_V_memcore_U->ce0      ( i_ce0 );
        cmpy_complex_top_refAtans_V_memcore_U->we0      ( i_we0 );
        cmpy_complex_top_refAtans_V_memcore_U->address0 ( memcore_iaddr );
        cmpy_complex_top_refAtans_V_memcore_U->d0       ( i_d0 );
        cmpy_complex_top_refAtans_V_memcore_U->q0       ( i_q0 );

        cmpy_complex_top_refAtans_V_memcore_U->ce1      ( t_ce0 );
        cmpy_complex_top_refAtans_V_memcore_U->we1      ( t_we0 );
        cmpy_complex_top_refAtans_V_memcore_U->address1 ( memcore_taddr );
        cmpy_complex_top_refAtans_V_memcore_U->d1       ( t_d0 );
        cmpy_complex_top_refAtans_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "cmpy_complex_top_refAtans_V.trace");
            // ports
