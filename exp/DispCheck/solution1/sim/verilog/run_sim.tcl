...
if {[file isfile cmpy_complex_top.autotvin.dat]} {
	file delete -force cmpy_complex_top.autotvin.dat
}

if {[file isfile cmpy_complex_top.autotvout.dat]} {
	file delete -force cmpy_complex_top.autotvout.dat
}
