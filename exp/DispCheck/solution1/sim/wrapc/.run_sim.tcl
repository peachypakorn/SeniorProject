...
set ::env(PATH) "$::env(PATH);C:/Xilinx2016/Vivado_HLS/2015.4/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2016/Vivado_HLS/2015.4/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx2016/Vivado_HLS/2015.4/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2016/Vivado_HLS/2015.4/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2016/Vivado_HLS/2015.4/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cmpy_complex_top.autotvin.dat"
	set constFileTvOut       "cmpy_complex_top.autotvout.dat"
	set constFileHdlTvIn     "cmpy_complex_top.autohdltvin.dat"
	set constFileHdlTvOut    "cmpy_complex_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
