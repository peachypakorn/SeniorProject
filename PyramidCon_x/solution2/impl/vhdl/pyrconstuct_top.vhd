...
architecture behav of pyrconstuct_top is 
    ...
    "pyrconstuct_top,hls_ip_2015_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.798000,HLS_SYN_LAT=2042,HLS_SYN_TPT=1654,HLS_SYN_MEM=27,HLS_SYN_DSP=26,HLS_SYN_FF=14394,HLS_SYN_LUT=11963}";
    ...
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_ap_start : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_ap_done : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_ap_continue : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_ap_idle : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_ap_ready : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_full_n : STD_LOGIC;
    signal pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_write : STD_LOGIC;
    ...
    signal pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TDATA : STD_LOGIC_VECTOR (39 downto 0);
    signal pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TVALID : STD_LOGIC;
    signal pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TREADY : STD_LOGIC;
    ...
    signal ap_reg_procdone_pyrconstuct_top_Block_codeRepl26_proc_U0 : STD_LOGIC := '0';
    ...
    component pyrconstuct_top_Block_codeRepl26_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    pyrconstuct_top_Block_codeRepl26_proc_U0 : component pyrconstuct_top_Block_codeRepl26_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    -- ap_reg_procdone_pyrconstuct_top_Block_codeRepl26_proc_U0 assign process. --
    ap_reg_procdone_pyrconstuct_top_Block_codeRepl26_proc_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_pyrconstuct_top_Block_codeRepl26_proc_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = pyrconstuct_top_Block_codeRepl26_proc_U0_ap_done)) then 
    ...
    fft_config_data_V_channel_din <= pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_din;
    fft_config_data_V_channel_read <= fft_config1_U0_config_ch_data_V_read;
    fft_config_data_V_channel_write <= pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_write;
    ...
    pyrconstuct_top_Block_codeRepl26_proc_U0_ap_start <= ap_start;
    pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_full_n <= fft_config_data_V_channel_full_n;
    ...
    pyrconstuct_top_Loop_2_proc_U0_ap_continue_assign_proc : process(ap_sig_ready_pyrconstuct_top_Loop_2_proc_U0_imgOutTmpBlockRam_M_real_V_pipo_status, ap_sig_ready_pyrconstuct_top_Loop_2_proc_U0_imgOutTmpBlockRam_M_imag_V_pipo_status)
    begin
        if (((ap_const_logic_1 = ap_sig_ready_pyrconstuct_top_Loop_2_proc_U0_imgOutTmpBlockRam_M_real_V_pipo_status) and (ap_const_logic_1 = ap_sig_ready_pyrconstuct_top_Loop_2_proc_U0_imgOutTmpBlockRam_M_imag_V_pipo_status))) then 
    ...
    pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TREADY <= pyrFilOut_V_TREADY;
end behav;
