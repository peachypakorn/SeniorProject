...
architecture behav of pyrconstuct_top_Loop_3_proc is 
    ...
    signal tmp_4_reg_318 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_8_fu_172_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_7_fu_249_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_fu_191_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_18_cast_fu_215_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal half_fu_233_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_236_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and not((ap_sig_bdd_98 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it6))) and (exitcond_i1_reg_299 = ap_const_lv1_0))) then
                ...
                tmp_4_reg_318 <= limits_q0(9 downto 1);
            end if;
        end if;
    end process;
    ...
    consFilters_V_address0 <= tmp_8_fu_172_p1(11 - 1 downto 0);
    ...
    fftPyrOut_M_imag_V_din <= grp_fu_285_p2(31 downto 8);
    ...
    fftPyrOut_M_real_V_din <= grp_fu_292_p2(31 downto 8);
    ...
    half_fu_233_p1 <= std_logic_vector(resize(unsigned(tmp_4_reg_318),32));
    i_1_fu_225_p3 <= 
        ap_const_lv32_0 when (tmp_1_fu_209_p2(0) = '1') else 
        i_fu_203_p2;
    i_fu_203_p2 <= std_logic_vector(unsigned(idx_phi_fu_136_p4) + unsigned(ap_const_lv32_1));
    idx_1_fu_197_p2 <= std_logic_vector(unsigned(tmp_5_fu_191_p2) - unsigned(nlimit_cast_fu_177_p1));
    idx_2_fu_242_p3 <= 
        idx_reg_132 when (tmp_6_fu_236_p2(0) = '1') else 
        idx_1_reg_323;
    ...
    imgOutTmpBlockRam_M_imag_V_address0 <= tmp_7_fu_249_p1(9 - 1 downto 0);
    ...
    imgOutTmpBlockRam_M_real_V_address0 <= tmp_7_fu_249_p1(9 - 1 downto 0);
    ...
    l_fu_219_p2 <= std_logic_vector(unsigned(l_0_i_reg_120) + unsigned(tmp_18_cast_fu_215_p1));
    limits_address0 <= tmp_3_fu_167_p1(4 - 1 downto 0);
    ...
    tmp_18_cast_fu_215_p1 <= std_logic_vector(resize(unsigned(tmp_1_fu_209_p2),11));
    tmp_1_fu_209_p2 <= "1" when (nlimit_cast_fu_177_p1 = i_fu_203_p2) else "0";
    tmp_3_fu_167_p1 <= std_logic_vector(resize(unsigned(l_0_i_phi_fu_124_p4),64));
    tmp_5_fu_191_p2 <= std_logic_vector(unsigned(idx_phi_fu_136_p4) + unsigned(ap_const_lv32_200));
    tmp_6_fu_236_p2 <= "1" when (signed(idx_reg_132) < signed(half_fu_233_p1)) else "0";
        tmp_7_fu_249_p1 <= std_logic_vector(resize(signed(idx_2_reg_343),64));

    tmp_8_fu_172_p1 <= std_logic_vector(resize(unsigned(coefIdx_0_i_reg_144),64));
end behav;
