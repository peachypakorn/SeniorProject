...
if {[file isfile pyrconstuct_top.autotvin.dat]} {
	file delete -force pyrconstuct_top.autotvin.dat
}

if {[file isfile pyrconstuct_top.autotvout.dat]} {
	file delete -force pyrconstuct_top.autotvout.dat
}
