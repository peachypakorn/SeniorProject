...
struct pyrconstuct_top : public sc_module {
    ...
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_ap_start;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_ap_done;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_ap_continue;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_ap_idle;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_ap_ready;
    sc_signal< sc_lv<8> > pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_din;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_full_n;
    sc_signal< sc_logic > pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_write;
    ...
    sc_signal< sc_lv<40> > pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TDATA;
    sc_signal< sc_logic > pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TVALID;
    sc_signal< sc_logic > pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TREADY;
    ...
    sc_signal< sc_logic > ap_reg_procdone_pyrconstuct_top_Block_codeRepl26_proc_U0;
    ...
    void thread_pyrconstuct_top_Block_codeRepl26_proc_U0_ap_continue();
    void thread_pyrconstuct_top_Block_codeRepl26_proc_U0_ap_start();
    void thread_pyrconstuct_top_Block_codeRepl26_proc_U0_fft_config_data_V_full_n();
    ...
    void thread_pyrconstuct_top_Loop_5_proc_U0_pyrFilOut_V_TREADY();
