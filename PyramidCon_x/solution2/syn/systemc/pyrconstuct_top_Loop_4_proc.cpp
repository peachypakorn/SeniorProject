...
void pyrconstuct_top_Loop_4_proc::thread_imgInTmp2_din() {
    imgInTmp2_din = esl_concat<25,7>(esl_concat<16,9>(esl_concat<9,7>(tmp_2_fu_100_p4.read(), ap_const_lv7_0), tmp_fu_90_p4.read()), ap_const_lv7_0);
}
...
void pyrconstuct_top_Loop_4_proc::thread_tmp_2_fu_100_p4() {
    tmp_2_fu_100_p4 = fftPyrOut_M_imag_V_dout.read().range(9, 1);
}
