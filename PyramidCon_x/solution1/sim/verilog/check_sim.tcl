...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pyrconstuct_top.autotvin_imgIn_M_real_V.dat"
         "c.pyrconstuct_top.autotvin_imgIn_M_imag_V.dat"
         "c.pyrconstuct_top.autotvin_pyrFilOut_V.dat"
         "c.pyrconstuct_top.autotvout_pyrFilOut_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pyrconstuct_top.autotvout_pyrFilOut_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
