...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FIFO_DEPTH {2048} CONFIG.FIFO_MODE {1} CONFIG.TDATA_NUM_BYTES {4}  ] $axis_data_fifo_0
...
CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_S_AXI_HP0 {1} \
  ...
  set_property -dict [ list CONFIG.implementation_options {automatically_select} CONFIG.number_of_stages_using_block_ram_for_data_and_phase_factors {0} CONFIG.transform_length {64}  ] $xfft_0
