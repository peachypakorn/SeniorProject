...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FIFO_DEPTH {4096} CONFIG.FIFO_MODE {2} CONFIG.TDATA_NUM_BYTES {4}  ] $axis_data_fifo_0
...
CONFIG.PCW_SD0_PERIPHERAL_ENABLE {1} CONFIG.PCW_UART1_PERIPHERAL_ENABLE {1} \
