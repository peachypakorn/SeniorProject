...
set rc [catch {
  ...
  report_drc -file FFTDMADesign_wrapper_drc_opted.rpt
...
set rc [catch {
  ...
  report_io -file FFTDMADesign_wrapper_io_placed.rpt
  report_utilization -file FFTDMADesign_wrapper_utilization_placed.rpt -pb FFTDMADesign_wrapper_utilization_placed.pb
  report_control_sets -verbose -file FFTDMADesign_wrapper_control_sets_placed.rpt
...
set rc [catch {
  ...
  report_drc -file FFTDMADesign_wrapper_drc_routed.rpt -pb FFTDMADesign_wrapper_drc_routed.pb
  report_timing_summary -warn_on_violation -max_paths 10 -file FFTDMADesign_wrapper_timing_summary_routed.rpt -rpx FFTDMADesign_wrapper_timing_summary_routed.rpx
  report_power -file FFTDMADesign_wrapper_power_routed.rpt -pb FFTDMADesign_wrapper_power_summary_routed.pb
  report_route_status -file FFTDMADesign_wrapper_route_status.rpt -pb FFTDMADesign_wrapper_route_status.pb
  report_clock_utilization -file FFTDMADesign_wrapper_clock_utilization_routed.rpt
...
set rc [catch {
  ...
  catch { write_mem_info -force FFTDMADesign_wrapper.mmi }
  write_bitstream -force FFTDMADesign_wrapper.bit 
  catch { write_sysdef -hwdef FFTDMADesign_wrapper.hwdef -bitfile FFTDMADesign_wrapper.bit -meminfo FFTDMADesign_wrapper.mmi -file FFTDMADesign_wrapper.sysdef }
