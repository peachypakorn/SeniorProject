...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_addr_width {32} CONFIG.c_m_axi_mm2s_data_width {32} CONFIG.c_m_axis_mm2s_tdata_width {32} CONFIG.c_mm2s_burst_size {16} CONFIG.c_sg_include_stscntrl_strm {0}  ] $axi_dma_0
...
CONFIG.PCW_ENET1_PERIPHERAL_ENABLE {0} CONFIG.PCW_GPIO_EMIO_GPIO_ENABLE {1} \
...
CONFIG.PCW_UART1_GRP_FULL_ENABLE {1} CONFIG.PCW_UART1_PERIPHERAL_ENABLE {1} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {.345} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {.345} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {.270} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {.272} \
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.029} CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.030} \
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {-0.002} CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {-0.011} \
CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41J128M16 HA-15E} CONFIG.PCW_UIPARAM_DDR_USE_INTERNAL_VREF {1} \
CONFIG.PCW_USB0_PERIPHERAL_ENABLE {1} CONFIG.PCW_USB1_PERIPHERAL_ENABLE {0} \
CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_S_AXI_HP0 {1} \
  ...
  set_property -dict [ list CONFIG.data_format {fixed_point} CONFIG.implementation_options {automatically_select} CONFIG.input_width {16} CONFIG.number_of_stages_using_block_ram_for_data_and_phase_factors {0} CONFIG.output_ordering {natural_order} CONFIG.phase_factor_width {24} CONFIG.transform_length {1024}  ] $xfft_0
