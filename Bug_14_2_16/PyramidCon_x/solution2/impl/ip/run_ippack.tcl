...
set Vendor      "pitchaya"
set Library     "hls"
set IPName      "pyrconstuct_top"
set Version     "1.0"
set DisplayName "PyrConstruction"
set Revision    "1602121709"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "pyrconstuct_top"
...
set Interfaces {
    ap_clk {
        ...
        buses "imgIn pyrFilOut_V_M_real_V pyrFilOut_V_M_imag_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    pyrFilOut_V_M_real_V {
        type "axi4stream"
        mode "master"
        port_prefix "pyrFilOut_V_M_real_V"
        has_tready "1"
        ports {
            TDATA 24
        }
    ...
    pyrFilOut_V_M_imag_V {
        type "axi4stream"
        mode "master"
        port_prefix "pyrFilOut_V_M_imag_V"
        has_tready "1"
        ports {
            TDATA 24
        }
...
## System Info
set user_parameters_list {clk_period 5.000000 machine 64 combinational 0 latency 2042 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Peachy/Desktop/SeniorProj/PyramidCon_x/pyramidbuild.cpp}
if {$enable_xo_gen} {
