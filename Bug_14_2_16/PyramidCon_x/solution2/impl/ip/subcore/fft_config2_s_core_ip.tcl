create_ip -vlnv xilinx.com:ip:xfft:9.0 -module_name fft_config2_s_core
set_property -dict [list \
    ...
    CONFIG.xk_index {0} \
] -objects [get_ips fft_config2_s_core]
set_property generate_synth_checkpoint false [get_files fft_config2_s_core.xci]
generate_target {synthesis simulation} [get_files fft_config2_s_core.xci]
