...
entity pyrconstuct_top_Block_codeRepl20_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pyrconstuct_top_Block_codeRepl20_proc is 
...
begin
    ...
    ap_sig_bdd_37_assign_proc : process(ap_start, ap_done_reg, fft_config_data_V_full_n)
    begin
                ap_sig_bdd_37 <= ((fft_config_data_V_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    -- fft_config_data_V_write assign process. --
    fft_config_data_V_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_bdd_37)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_bdd_37))) then 
