...
#ifndef _pyrconstuct_top_imgOutTmpBlockRam_M_real_V_H_
#define _pyrconstuct_top_imgOutTmpBlockRam_M_real_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore.h"

SC_MODULE(pyrconstuct_top_imgOutTmpBlockRam_M_real_V) {
...
protected:
    ...
    pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore* pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U;
...
public:
    ...
    SC_CTOR(pyrconstuct_top_imgOutTmpBlockRam_M_real_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U = new pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore("pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U");
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->clk      ( clk );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->reset    ( reset );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->ce0      ( i_ce0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->we0      ( i_we0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->address0 ( memcore_iaddr );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->d0       ( i_d0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->q0       ( i_q0 );

        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->ce1      ( t_ce0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->we1      ( t_we0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->address1 ( memcore_taddr );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->d1       ( t_d0 );
        pyrconstuct_top_imgOutTmpBlockRam_M_real_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "pyrconstuct_top_imgOutTmpBlockRam_M_real_V.trace");
            // ports
