; ModuleID = 'C:/Users/Peachy/Desktop/SeniorProj/PyramidCon_x/solution2/.autopilot/db/a.o.2.bc'
...
define void @pyrconstuct_top(i32* %imgIn, i24* %pyrFilOut_V_M_real_V, i24* %pyrFilOut_V_M_imag_V, i32 %nL) {
codeRepl:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i24* %pyrFilOut_V_M_real_V), !map !16
  call void (...)* @_ssdm_op_SpecBitsMap(i24* %pyrFilOut_V_M_imag_V), !map !22
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %nL), !map !26
  ...
  call void (...)* @_ssdm_op_SpecInterface(i24* %pyrFilOut_V_M_real_V, i24* %pyrFilOut_V_M_imag_V, [5 x i8]* @p_str274, i32 0, i32 0, i32 0, i32 1520, [1 x i8]* @p_str275, [1 x i8]* @p_str275, [1 x i8]* @p_str275, [1 x i8]* @p_str275)
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @p_str275) nounwind
  call fastcc void @pyrconstuct_top_Block_codeRepl20_proc(i8* %fft_config_data_V_channel)
  ...
  call fastcc void @pyrconstuct_top_Loop_5_proc(i48* %ifftPyrOut_channel, i24* %pyrFilOut_V_M_real_V, i24* %pyrFilOut_V_M_imag_V)
  ret void
}
...
define weak void @_ssdm_op_Write.axis.volatile.i24P.i24P(i24*, i24*, i24, i24) {
entry:
  store i24 %2, i24* %0
  store i24 %3, i24* %1
  ret void
...
entry:
  ...
  %empty_69 = zext i1 %1 to i2
  %empty_70 = shl i2 %empty, 1
  %empty_71 = or i2 %empty_70, %empty_69
  ret i2 %empty_71
}
...
define internal fastcc void @pyrconstuct_top_Loop_5_proc(i48* %ifftPyrOut, i24* %pyrFilOut_V_M_real_V, i24* %pyrFilOut_V_M_imag_V) {
newFuncRoot:
  call void (...)* @_ssdm_op_SpecInterface(i24* %pyrFilOut_V_M_imag_V, i24* %pyrFilOut_V_M_real_V, [5 x i8]* @p_str274, i32 0, i32 0, i32 0, i32 1520, [1 x i8]* @p_str275, [1 x i8]* @p_str275, [1 x i8]* @p_str275, [1 x i8]* @p_str275)
...
"ap_fixed_base<24, 11, true, 5, 3, 0>.exit":      ; preds = %0
  ...
  %tmp = call i1 @_ssdm_op_BitSelect.i1.i48.i32(i48 %ifftPyrOut_read, i32 9)
  %tmp_31_cast = zext i1 %tmp to i15
  %p_Val2_s = add i15 %tmp_31_cast, %p_Val2_2_cast
  %tmp_1 = call i14 @_ssdm_op_PartSelect.i14.i48.i32.i32(i48 %ifftPyrOut_read, i32 34, i32 47)
  %p_Val2_4_cast = sext i14 %tmp_1 to i15
  %tmp_2 = call i1 @_ssdm_op_BitSelect.i1.i48.i32(i48 %ifftPyrOut_read, i32 33)
  %tmp_34_cast = zext i1 %tmp_2 to i15
  %p_Val2_2 = add i15 %tmp_34_cast, %p_Val2_4_cast
  %cast = sext i15 %p_Val2_s to i24
  %cast5 = sext i15 %p_Val2_2 to i24
  call void @_ssdm_op_Write.axis.volatile.i24P.i24P(i24* %pyrFilOut_V_M_real_V, i24* %pyrFilOut_V_M_imag_V, i24 %cast, i24 %cast5)
  %empty_72 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str277, i32 %tmp_s)
  br label %0
}
...
._crit_edge:                                      ; preds = %0
  ...
  %tmp_1 = call i9 @_ssdm_op_PartSelect.i9.i24.i32.i32(i24 %fftPyrOut_M_imag_V_read, i32 1, i32 9)
  %imgInTmp2_1_addr_23940_part_se = call i32 @_ssdm_op_BitConcatenate.i32.i9.i7.i9.i7(i9 %tmp_1, i7 0, i9 %tmp, i7 0)
  call void @_ssdm_op_Write.ap_fifo.volatile.i32P(i32* %imgInTmp2, i32 %imgInTmp2_1_addr_23940_part_se)
  %empty_73 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str276, i32 %tmp_s)
  br label %0
}
...
_ifconv:                                          ; preds = %"dummy_proc2<complex<ap_fixed<24, 16, 5, 3, 0> > >.exit"
  ...
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str311)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str275) nounwind
  %tmp_2 = zext i11 %l_0_i to i64
  %limits_addr = getelementptr [12 x i10]* @limits, i64 0, i64 %tmp_2
  %nlimit = load i10* %limits_addr, align 2
  %nlimit_cast = zext i10 %nlimit to i32
  %tmp_3 = call i9 @_ssdm_op_PartSelect.i9.i10.i32.i32(i10 %nlimit, i32 1, i32 9)
  %half = zext i9 %tmp_3 to i32
  %tmp_5 = icmp slt i32 %idx, %half
  %tmp_9 = add i32 %idx, 512
  %idx_1 = sub i32 %tmp_9, %nlimit_cast
  %idx_2 = select i1 %tmp_5, i32 %idx, i32 %idx_1
  %tmp_4 = sext i32 %idx_2 to i64
  %imgOutTmpBlockRam_M_real_V_ad = getelementptr [512 x i24]* %imgOutTmpBlockRam_M_real_V, i64 0, i64 %tmp_4
  ...
  %imgOutTmpBlockRam_M_imag_V_ad = getelementptr [512 x i24]* %imgOutTmpBlockRam_M_imag_V, i64 0, i64 %tmp_4
  ...
  %tmp_6 = zext i11 %coefIdx_0_i to i64
  %consFilters_V_addr = getelementptr [1520 x i9]* @consFilters_V, i64 0, i64 %tmp_6
  ...
  %tmp_7 = call i24 @_ssdm_op_PartSelect.i24.i32.i32.i32(i32 %p_Val2_s, i32 8, i32 31)
  %tmp_8 = call i24 @_ssdm_op_PartSelect.i24.i32.i32.i32(i32 %p_Val2_1, i32 8, i32 31)
  call void @_ssdm_op_Write.ap_fifo.volatile.i24P(i24* %fftPyrOut_M_real_V, i24 %tmp_7)
  call void @_ssdm_op_Write.ap_fifo.volatile.i24P(i24* %fftPyrOut_M_imag_V, i24 %tmp_8)
  %i = add nsw i32 %idx, 1
  %tmp_s = icmp eq i32 %nlimit_cast, %i
  %tmp_17_cast = zext i1 %tmp_s to i11
  %l = add i11 %l_0_i, %tmp_17_cast
  %i_1 = select i1 %tmp_s, i32 0, i32 %i
  %empty_74 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str311, i32 %tmp)
  br label %"dummy_proc2<complex<ap_fixed<24, 16, 5, 3, 0> > >.exit"
}
...
define internal fastcc void @pyrconstuct_top_Block_codeRepl20_proc(i8* %fft_config_data_V) {
newFuncRoot:
...
!23 = metadata !{i32 0, i32 16, metadata !24}
!24 = metadata !{metadata !25}
!25 = metadata !{metadata !"pyrFilOut.V._M_imag.V", metadata !20, metadata !"int17", i32 0, i32 16}
!26 = metadata !{metadata !27}
!27 = metadata !{i32 0, i32 31, metadata !28}
!28 = metadata !{metadata !29}
!29 = metadata !{metadata !"nL", metadata !30, metadata !"int", i32 0, i32 31}
