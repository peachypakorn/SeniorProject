...
module AESL_autofifo_pyrFilOut_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.pyrconstuct_top.autotvin_pyrFilOut_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.pyrconstuct_top.autotvout_pyrFilOut_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 34;
