...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & ~(ap_sig_bdd_98 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it6)) & (exitcond_i1_reg_299 == ap_const_lv1_0))) begin
        ...
        tmp_3_reg_318 <= {{limits_q0[ap_const_lv32_9 : ap_const_lv32_1]}};
    end
end
...
assign consFilters_V_address0 = tmp_6_fu_172_p1;

assign exitcond_i1_fu_155_p2 = (coefIdx_0_i_reg_144 == ap_const_lv11_5F0? 1'b1: 1'b0);

assign fftPyrOut_M_imag_V_din = {{grp_fu_292_p2[ap_const_lv32_1F : ap_const_lv32_8]}};

assign fftPyrOut_M_real_V_din = {{grp_fu_285_p2[ap_const_lv32_1F : ap_const_lv32_8]}};

assign grp_fu_285_p0 = OP2_V_cast_fu_262_p1;

assign grp_fu_292_p0 = OP2_V_cast_fu_262_p1;

assign half_fu_233_p1 = tmp_3_reg_318;

assign i_1_fu_225_p3 = ((tmp_s_fu_209_p2[0:0] === 1'b1) ? ap_const_lv32_0 : i_fu_203_p2);

assign i_fu_203_p2 = (idx_phi_fu_136_p4 + ap_const_lv32_1);

assign idx_1_fu_197_p2 = (tmp_9_fu_191_p2 - nlimit_cast_fu_177_p1);

assign idx_2_fu_242_p3 = ((tmp_5_fu_236_p2[0:0] === 1'b1) ? idx_reg_132 : idx_1_reg_323);

assign imgOutTmpBlockRam_M_imag_V_address0 = tmp_4_fu_249_p1;

assign imgOutTmpBlockRam_M_real_V_address0 = tmp_4_fu_249_p1;

assign l_fu_219_p2 = (l_0_i_reg_120 + tmp_17_cast_fu_215_p1);

assign limits_address0 = tmp_2_fu_167_p1;

assign nlimit_cast_fu_177_p1 = limits_q0;

assign tmp_17_cast_fu_215_p1 = tmp_s_fu_209_p2;

assign tmp_2_fu_167_p1 = l_0_i_phi_fu_124_p4;

assign tmp_4_fu_249_p1 = $signed(idx_2_reg_343);

assign tmp_5_fu_236_p2 = ($signed(idx_reg_132) < $signed(half_fu_233_p1)? 1'b1: 1'b0);

assign tmp_6_fu_172_p1 = coefIdx_0_i_reg_144;

assign tmp_9_fu_191_p2 = (idx_phi_fu_136_p4 + ap_const_lv32_200);

assign tmp_s_fu_209_p2 = (nlimit_cast_fu_177_p1 == i_fu_203_p2? 1'b1: 1'b0);
