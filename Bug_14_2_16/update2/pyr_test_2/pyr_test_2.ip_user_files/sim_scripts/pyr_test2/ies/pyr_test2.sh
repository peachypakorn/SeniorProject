...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    ...
    "$ref_dir/../../../bd/pyr_test2/ip/pyr_test2_pyrconstuct_top_0_0/sim/pyr_test2_pyrconstuct_top_0_0.vhd" \
...
elaborate()
{
  opts="-loadvpi "C:/Xilinx2016/Vivado/2015.4/lib/win64.o/libxil_ncsim.dll:xilinx_register_systf" -64bit -relax -access +rwc -messages -logfile elaborate.log -timescale 1ps/1ps"
