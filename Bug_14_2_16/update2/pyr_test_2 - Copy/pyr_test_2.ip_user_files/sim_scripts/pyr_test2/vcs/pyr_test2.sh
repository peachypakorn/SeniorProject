...
reset_run()
{
  files_to_remove=(ucli.key pyr_test2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc pyr_test2_simv.daidir)
...
compile()
{
  ...
  vlogan -work axis_register_slice_v1_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
  ...
  vlogan -work axis_subset_converter_v1_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.pyr_test2 xil_defaultlib.glbl -o pyr_test2_simv
}
...
simulate()
{
  ...
  ./pyr_test2_simv $opts -do simulate.do
}
# Script usage
usage()
{
