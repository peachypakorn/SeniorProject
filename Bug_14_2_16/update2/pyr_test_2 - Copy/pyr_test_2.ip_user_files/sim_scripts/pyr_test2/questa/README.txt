...
#
# Generated by export_simulation on Sun Feb 14 00:30:27 +0700 2016
#
################################################################################
...
switch to the './pyr_test2.sh' script.

./pyr_test2.sh -reset_run
...
./pyr_test2.sh -noclean_files

For more information on the script, please type './pyr_test2.sh -help'.
